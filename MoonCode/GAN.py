...
def main():
    ...
    # 使用正确的权重路径
    model_path = 'GAN_Supplementary Experiment/Full-Scale-Detection-and-Chronological-Analysis-of-Lunar-Impact-Craters-master/split processing/GAN/GFPGANv1.3.pth'
    ...
    for img_path in img_list:
        ...
        if restored_img is not None:
            ...
            save_path = os.path.join(args.output, f'{basename}_GAN.tif')
